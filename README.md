...
<p style="text-align: left;">The data is sourced with a SQL query directly from the Data Lake, utomatically refreshed every Monday.</p>
<p style="text-align: left;">The controls at the top give us the possibility to dive deep into different kinds of items and different granularity(ex: countries and warehouses).</p>
